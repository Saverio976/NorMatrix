...
try:
    ...
    from normatrix.plugged.preprocessor import check
    from normatrix.source.context import Context
except ModuleNotFoundError:
    from src.normatrix.source.file_parser import parse
    from src.normatrix.plugged.preprocessor import check
...
class TestPreprocessor(unittest.TestCase):
    ...
    def test_ko_file(self):
        ...
        self.assertEqual(list_error[0][0], 3)
        self.assertEqual(list_error[1][0], 5)
        self.assertEqual(list_error[2][0], 7)
        self.assertEqual(list_error[3][0], 8)
