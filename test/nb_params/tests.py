...
bad_code = """
int abc(char *ab, int ac[], char const *ad, char *const *af[],
        struct kk agh)
{
    return (0);
}
...
class TestNbParams(unittest.TestCase):
    ...
    def test_ko_file(self):
        ...
        self.assertEqual(list_error[1][0], 8)
