...
try:
    ...
    from normatrix.plugged.newline_at_end_of_file import check
    from normatrix.source.context import Context
except ModuleNotFoundError:
    from src.normatrix.source.file_parser import parse
    from src.normatrix.plugged.newline_at_end_of_file import check
...
class TestNewlineAtEndOfFile(unittest.TestCase):
