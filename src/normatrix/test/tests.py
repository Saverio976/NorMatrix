...
try:
    ...
    from normatrix.test.unittests.newline_at_end_of_file.tests import (
        TestNewlineAtEndOfFile,
    )
    ...
    from src.normatrix.test.unittests.newline_at_end_of_file.tests import (
        TestNewlineAtEndOfFile,
    )
